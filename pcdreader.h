...
int pclreader()
{
    ...
    if (pcl::io::loadPCDFile<pcl::PointXYZRGB> ("../dataset/cloud_1.pcd", *cloud) == -1) //* load the file
    {
    ...
    cv::Mat img = cv::imread("../dataset/image_1.png", cv::IMREAD_COLOR);//CV_LOAD_IMAGE_COLOR
